...
def test():
    ...
    dataset = Wildtrack(os.path.expanduser('D:/PIASPACE_2D_MAPPING/Multi-view-People-Detection-in-Large-Scenes-via-Supervised-View-wise-Contribution-Weighting-main/data/Datasets/Wildtrack'), )
